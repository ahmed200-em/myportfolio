...
document.addEventListener('DOMContentLoaded', function () {
  const animateElements = document.querySelectorAll(
    '.stat-item, .skill-item, .project-card, .stats'
  )
...
const skillsDatabase = {
  ...
  python: {
    ...
    level: 90,
    description:
      'Versatile language for backend development and security automation',
    experience: '4+ years',
    projects: [
  ...
  hacking: {
    ...
    level: 92,
    description:
      'Authorized hacking to identify and fix security vulnerabilities',
    experience: '4+ years',
  ...
  auditing: {
    ...
    level: 87,
    description:
      'Comprehensive security assessment and compliance verification',
    experience: '3+ years',
  ...
  attacks: {
    ...
    level: 91,
    description:
      'Comprehensive knowledge of various cyber attack methodologies',
    experience: '4+ years',
    projects: [
      'Threat Modeling',
      'Attack Simulation',
  ...
  searching: {
    name: 'Advanced OSINT & Threat Hunting',
    category: 'Threat Intelligence',
    level: 88,
    description:
      'Expertise in deep-web investigations, advanced search operators, and intelligence gathering',
    experience: '3+ years',
    projects: [
      'Digital Footprint Analysis',
      'Asset Discovery Automation',
      'Incident Attribution Investigations'
    ],
    frameworks: [
      'OSINT Framework',
      'Maltego Graphing',
      'Google Dorking Methodology',
      'Sock Puppet Operations'
    ],
    specialties: [
      'Dorking & Advanced Operators',
...
function addSkillBar (skill, outputElement) {
  ...
  // Animate skill bar
  setTimeout(() => {
    const skillBarFill = outputElement.querySelector(
      '.skill-bar-fill[data-level="' + skill.level + '"]'
    )
    if (skillBarFill) {
...
function initializeSkillsClickHandlers () {
  ...
  skillItems.forEach(skillItem => {
    skillItem.addEventListener('click', function () {
      const skillName = this.querySelector('span')
